          ...
          <form onSubmit={handleSubmit} method="POST" action="" className={styles.form + " mb-5"}>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 d-none d-lg-block">
                ...
                <p><b>Lista ordinata</b>: <code>n. testo</code> (n = numero)</p>
                <p><b>Lista non ordinata</b>: <code>- testo</code></p>
                ...
                <div>
                  {image?.target?.files[0] ?
                    <div className="d-flex justify-content-center align-items-end">
                      <Image className={styles.imagePreview + " " + styles.imagePreviewBorder + " d-none d-lg-flex"} src={URL.createObjectURL(image.target.files[0])} alt="Immagine di gestione" width={1000} height={0} unoptimized ></Image>
                      <Image className={styles.imagePreviewBorder + " d-lg-none img-fluid"} src={URL.createObjectURL(image.target.files[0])} alt="Immagine di gestione" width={1000} height={0}unoptimized ></Image>
                    </div>
                    : ""}
                </div>
              </div>
