...
export async function POST(request) {
  ...
  db.all("INSERT INTO article (titolo, testo, id_utente, image_url, uri_article, created_at, isApproved) VALUES (?, ?, ?, ?, ?, ?, ?)", title, content, id_utente, `/posts-images/${randomFileName}.webp`, uri, `${date.getTime()}`, 0);
