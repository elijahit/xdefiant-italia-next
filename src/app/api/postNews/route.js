...
export async function GET(request) {
  ...
  if(searchParams.get('limit')) {
    ...
    let res = await db.all("select a.id_article , a.titolo, a.testo, a.id_utente, a.image_url, a.uri_article, u.username, u.email, u.discord_name, a.created_at from article a join utente u on u.id_utente = a.id_utente WHERE isApproved = ? ORDER BY a.id_article DESC LIMIT ?", 1, query)
